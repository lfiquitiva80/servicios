...
class soatalerta extends Mailable
{
    public $value;
    ...
    public function build()
    {
        //return $this->markdown('emails.soat');
             return $this->markdown('emails.soat')->subject('[¡Alerta!] EL SOAT DEL VEHICULO: '. $this->value->placa.' SE VENCE DENTRO DE 20 DIAS')->with([
                 'id' => $this->value->id,
