...
class alertaslicencia extends Mailable
{
    public $value;
    ...
    {
        //return $this->markdown('emails.soat');
         return $this->markdown('emails.licencia')->subject('[¡Alerta!] LA LICENCIA DEL VEHICULO: '. $this->value->placa.' SE VENCE DENTRO DE 20 DIAS')->with([
             'id' => $this->value->id,
