...
class alertastecnomecanica extends Mailable
{
    public $value;
    ...
    {
        return $this->markdown('emails.tecnomecanica')->subject('[¡Alerta!] LA TÉCNICO MECÁNICA DEL VEHICULO: '. $this->value->placa.' SE VENCE DENTRO DE 20 DIAS')->with([
            'id' => $this->value->id,
