    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Actualizar Provision</h4>
            </div>
            <div class="modal-body">
                  <form class="" action="{{route('provision.update', 'id' )}}"  id="provisionUpdate" method="post"  >
                    {{method_field('patch')}}
                    {{csrf_field()}}
                    ...
                    <div class="col-xs-4">
                     <div class="form-group">
                        ...
                        {!! Form::select('id_proveedor',$proveedor,null,['class'=> 'form-control id_proveedoredit','placeholder' => 'Seleccione el nit del proveedor','name'=>'id_proveedor','id'=>'id_proveedor'] )!!}
                      </div>
                    </div>
                    <div class="col-xs-4">
                     <div class="form-group">
                    ...
                    <div class="col-xs-4">
                        <div class="form-group">
                           ...
                           {!! Form::select('id_centro_de_costos',$costo,null,['class'=> 'form-control idcostosedit','placeholder' => 'Seleccione el nit del centro de costos','name'=>'id_centro_de_costos','id'=>'id_centro_de_costos'] )!!}
                     ...
                     <div class="col-xs-4">
                        ...
                        <div class="col-xs-4">
                                 <div class="form-group">
                                       ...
                                       {!! Form::select('id_ot',$ot,null,['class'=> 'form-control otedit','placeholder' => 'Seleccione','name'=>'id_ot','id'=>'id_ot'] )!!}
                       ...
                       <div class="col-xs-4">
                        ...
                        <div class="col-xs-4">
                            <div class="form-group">
                               ...
                               {!! Form::select('id_puc',$puc,null,['class'=> 'form-control idpucedit','name'=>'id_puc','id'=>'id_puc'] )!!}
                        ...
                        <div class="col-xs-4">
                           <div class="form-group">
                              ...
                              {!! Form::select('id_estadofacturacion',[ ''=>'SELECCIONE','1'=>'REVISIÓN', '2' =>'DEVOLUCIÓN'],null,['class'=> 'form-control estado','name'=>'id_estadofacturacion','id'=>'id_estadofacturacion'] )!!}
                         <input type="text" class="form-control estadofacturacion" style="display: none" disabled>
                             </div>
                        </div>
                        <div class="col-xs-4">
                            <div class="form-group">
                               <label for="id">Cuenta </label>
                                <input type="text" class="form-control cuentaedit" disabled placeholder="Cuenta">
                            </div>
                         </div> 
                         <div class="col-xs-2">
                              <div class="form-group">
                                 <label for="id">Fecha </label>
                                 {!! Form::text('mes',null,['class' => 'form-control mes','placeholder' => 'FECHA','name'=>'mes','id'=>'mes']) !!}    
                                </div>
                           </div>
                        ...
                        <div class="col-xs-2"> 
                              <div class="form-group">
                                    ...
                                    {!! Form::select('id_lineadenegocio',$lnegocio,null,['class'=> 'form-control lnegocioedit','placeholder' => 'Seleccione','name'=>'id_lineadenegocio','id'=>'id_lineadenegocio'] )!!}
                                   
                                    {!! Form::select('id_lineadenegocio',$lnegocio,null,['class'=> 'form-control lnegocioedit','placeholder' => 'Seleccione','name'=>'id_lineadenegocio','id'=>'id_lineadenegocio','style'=>'display: none'] )!!}
                                 </div>
                              </div>  
                        ...
                        <div class="col-xs-4">
                                <div class="form-group">
                                   ...
                                   {!! Form::text('detalle',null,['class'=> 'form-control detalleedit','placeholder' => 'DETALLE', 'name'=>'detalle','id'=>'detalle'] )!!}   
                                </div>
                             </div>   
                        <div class="col-xs-4">
                            <div class="form-group">
