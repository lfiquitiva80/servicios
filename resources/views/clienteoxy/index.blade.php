...
<h4><b><center>REGISTROS DE OCCIDENTAL DE COLOMBIA Y OCCIDENTAL ANDINA</h4></b></center>
...
<br><br>
<table id="ordendeservicio" class="table table-striped table-hover table-responsive "  style="width:100%" >
...
function filterColumn ( i ) {
    $('#ordendeservicio').DataTable().column( i ).search(
        $('#col'+i+'_filter').val(),
    ).draw();
}
 $(document).ready(function() {
    $('#ordendeservicio').DataTable({
            "serverSide": true,
            "ajax" : "{{ url('ordenesdeserviciooxyall') }}",
             ...
             columnDefs: [
                ...
                { orderable: false, targets: '_all' },
                 ...
                 { targets : [8],
                   render : function (data, type, row) {
                            switch(data) {
                            case null: return '<span class="label label-default">POR FACTURAR </span>';
