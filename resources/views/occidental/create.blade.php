...
{!! Form::open(['route' => 'occidental.store', 'method'=>'POST']) !!}
	<legend>CREAR ORDENES ADICIONALES OCCIDENTAL</legend>
...
<div class="col-xs-3">
	<div class="form-group">
		...
		<input type="text" class="form-control input-lg" name="item_de_contrato"  id="item_de_contrato" placeholder="item_de_contrato">
	</div>
</div>
...
<div class="col-xs-3">
	<div class="form-group">
		...
		<input type="text" class="form-control input-lg" name="poet"  id="poet" placeholder="poet">
	</div>
</div>
...
<div class="col-xs-3">
	<div class="form-group">
		...
		<input type="text" class="form-control input-lg" name="dia"  id="dia" placeholder="dia">
	</div>
</div>
