...
{!! Form::open(['route' => ['occidental.update', $edit->id],'method'=>'PATCH','enctype'=>'multipart/form-data','file'=>true]) !!}

  <legend>EDITAR ORDENES DE SERVICIO OCCIDENTAL</legend>
...
<div class="col-xs-3">
  <div class="form-group">
    <label for="id">item_de_contrato</label>
    <input type="text" class="form-control input-lg" name="item_de_contrato"  id="item_de_contrato" placeholder="item_de_contrato" value="{{$edit->item_de_contrato}}">
  </div>
</div>
...
<div class="col-xs-3">
  <div class="form-group">
    <label for="id">poet</label>
    <input type="text" class="form-control input-lg" name="poet"  id="poet" placeholder="poet" value="{{$edit->poet}}">
  </div>
</div>

<div class="col-xs-3">
  <div class="form-group">
    <label for="id">dia</label>
    <input type="text" class="form-control input-lg" name="dia"  id="dia" placeholder="dia" value="{{$edit->dia}}">
  </div>
</div>
