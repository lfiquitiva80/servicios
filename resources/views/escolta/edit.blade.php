...
{!! Form::open(['route' => ['Escolta.update', $Escolta->id],'method'=>'PATCH','enctype'=>'multipart/form-data','file'=>true,'id'=>'reg_form']) !!}
...
<div class="form-group">
  ...
  {!! Form::text('nombre', $Escolta->nombre,['class' => 'form-control', 'placeholder' => 'Nombre completo', 'name'=>'nombre']) !!}
</div>
<div class="form-group">
      <label for="id">Cédula de Ciudadanía</label>
      {!! Form::number('cc', $Escolta->cc,['class' => 'form-control', 'placeholder' => 'Cédula de Ciudadanía','name'=>'cc']) !!}
  </div>

<div class="form-group">
        <label for="id">Teléfono</label>
        {!! Form::text('telefono', $Escolta->telefono,['class' => 'form-control', 'placeholder' => 'Teléfono','name'=>'telefono']) !!}

    </div>
    <div class="form-group">
                  <label for="id">Cargo</label>
                  {!! Form::text('cargo', $Escolta->cargo,['class' => 'form-control', 'placeholder' => 'Cargo','name'=>'cargo']) !!}

              </div>
              <div class="form-group">
                                    <label for="id">Activo</label>
                                    {!! Form::select('activo',[ ''=>'SELECCIONE','si'=>'Activo', 'no' =>'Inactivo'],$Escolta->activo,['class'=> 'form-control','name'=>'activo'] )!!}
                        </div>
              <div class="form-group">
                                        <label for="id">Ciudad</label>
                                        {!! Form::text('ciudad', $Escolta->ciudad,['class' => 'form-control', 'placeholder' => 'ciudad','name'=>'ciudad']) !!}
                                    </div>
                <div class="form-group">
                                        <label for="id">Bilingüe</label>
                                                      {!! Form::select('bilingue',[ ''=>'SELECCIONE','si'=>'SI', 'no' =>'NO'],$Escolta->bilingue,['class'=> 'form-control','name'=>'bilingue'] )!!}
                                                  </div>
