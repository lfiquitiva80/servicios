...
<h4><b><center>REGISTROS DE LA PREFACTURACION OTROS CLIENTES</h4></b></center>
               ...
               { targets : [1],
                 render : function (data, type, row) {
                          switch(data) {
                            ...
                            case '7' : return '<span class="label label-default">NO FACTURADO</span>'; break;
