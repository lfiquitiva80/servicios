...
@section('main-content')
 ...
 <script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/1.1.3/sweetalert.min.js"></script>
        ...
        {!! Form::open(['route' => 'Escolta.store', 'method'=>'POST','files'  => true ,'enctype'=>'multipart/form-data']) !!}
...
<div class="form-group">
      ...
      {!! Form::number('cc', null,['class' => 'form-control', 'placeholder' => 'Cédula de Ciudadanía']) !!}
  </div>
...
<div class="form-group">
                      ...
                      {!! Form::select('activo',[ ''=>'SELECCIONE','si'=>'Activo', 'no' =>'Inactivo'],null,['class'=> 'form-control '] )!!}
          </div>
<div class="form-group">
  ...
  <div class="form-group">
                          <label for="id">Bilingüe</label>
                                        {!! Form::select('bilingue',[ ''=>'SELECCIONE','si'=>'SI', 'no' =>'NO'],null,['class'=> 'form-control '] )!!}
                                    </div>
      <div class="form-group">
            <label for="id">Escolta Externo</label>
                         {!! Form::select('escolta_externo',[ ''=>'SELECCIONE','si'=>'SI', 'no' =>'NO'],null,['class'=> 'form-control '] )!!}
              </div>
